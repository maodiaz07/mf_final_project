...
# Number of features (excluding target colum)
num_features = len(df.columns) - 1

# Generate 5 new instances
# We'll sample values randomly based on the mean and str of existing data
new_data =[]
...
print("check Se agregaron 5 nuevas instancias al dataset. ")
